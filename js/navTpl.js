...
var dataText = {
	"navData":[
		...
		{"nav_tab":"运行维护","nav_list":[{"link":"Searchlog.html","link_name":"日志"},{"link":"FileManager.html","link_name":"文件管理器"},{"link":"partition.html","link_name":"数据库"}]},
        {"nav_tab":"应用配置","nav_list":[{"link":"model.html","link_name":"业务模块"},{"link":"admin-permissions.html","link_name":"权限定义"}]},
		{"nav_tab":"用户安全","nav_list":[{"link":"organization.html","link_name":"组织机构"},{"link":"group.html","link_name":"角色"},{"link":"user-list.html","link_name":"用户"}]}
	]
};
